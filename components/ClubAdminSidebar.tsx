  ...
  return (
    ...
    <div className="border-b border-slate-200 bg-white px-4 py-3 md:hidden">
      <div className="flex items-center justify-between gap-4">
        <Link href="/club-admin" className="flex items-center">
          <Image
        ...
        <button
          ...
          aria-label="Toggle club admin navigation"
      ...
      {isMenuOpen && (
        <nav className="mt-3 grid gap-2">
          {[
            ...navItems,
            { label: "Public Clubs", href: "/clubs", icon: null },
            { label: "Back to App", href: "/home", icon: null },
          ].map((item) => {
            const isActive =
